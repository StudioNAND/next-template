...
const MS_OFFICE_CHECKUP = 'office';

const isMSOffice = ua => (ua ? ua.indexOf(MS_OFFICE_CHECKUP) > -1 : true);
...
const browserIsSupported = (useragent, browserSatisfactions, passUnknownSatisfaction) => {
...
const createExpressBrowserCheckMiddleware = (options={}) => (req, res, next) => {
  const { 
